...
with DAG(
    ...
    params={"notification_emails":  Param(["kbalak01@kenvue.com","rchadw01@kenvue.com"])},
    ...
    @task.virtualenv(
            ...
            requirements=["tableauserverclient", "wheel", ],
        )
        def tell_a_joke():
            """
    ...
    chain(
          [execute_adf_pipeline('extract_redshift', 'JNJ_SNAP'),execute_adf_pipeline('extract_sharepoint_list', 'BODB_ONE_MSL')],
          [execute_snowflake_framework('JNJ_SNAP'),execute_snowflake_framework('BODB_ONE_MSL')],
