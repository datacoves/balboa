      ...
      create or replace transient table staging_BALBOA.source_dbt_artifacts.fct_dbt__exposures_updates copy grants as
      (with model_executions as (

    select * from source_dbt_artifacts.fct_dbt__model_executions

),

exposures_record as (

    select * from source_dbt_artifacts.dim_dbt__exposures
