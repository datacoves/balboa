begin;
    ...
    merge into staging_BALBOA.source_dbt_artifacts.int_dbt__model_executions as DBT_INTERNAL_DEST
        using staging_BALBOA.source_dbt_artifacts.int_dbt__model_executions__dbt_tmp as DBT_INTERNAL_SOURCE
        on 
    ...
    when not matched then insert
        ("MODEL_EXECUTION_ID", "COMMAND_INVOCATION_ID", "DBT_CLOUD_RUN_ID", "ARTIFACT_RUN_ID", "ARTIFACT_GENERATED_AT", "WAS_FULL_REFRESH", "NODE_ID", "THREAD_ID", "STATUS", "COMPILE_STARTED_AT", "QUERY_COMPLETED_AT", "TOTAL_NODE_RUNTIME", "ROWS_AFFECTED")
    values
        ("MODEL_EXECUTION_ID", "COMMAND_INVOCATION_ID", "DBT_CLOUD_RUN_ID", "ARTIFACT_RUN_ID", "ARTIFACT_GENERATED_AT", "WAS_FULL_REFRESH", "NODE_ID", "THREAD_ID", "STATUS", "COMPILE_STARTED_AT", "QUERY_COMPLETED_AT", "TOTAL_NODE_RUNTIME", "ROWS_AFFECTED")
