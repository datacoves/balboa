      ...
      create or replace transient table staging_BALBOA.source_dbt_artifacts.dim_dbt__current_models copy grants as
      (with run_results as (

    select *
    from source_dbt_artifacts.fct_dbt__run_results
...
models as (
    ...
    select *
    from source_dbt_artifacts.dim_dbt__models
...
model_executions as (
    ...
    select *
    from source_dbt_artifacts.fct_dbt__model_executions
