      ...
      create or replace transient table staging_BALBOA.source_dbt_artifacts.fct_dbt__critical_path copy grants as
      (with models as (
...
latest_executions as (
    ...
    select *
    from source_dbt_artifacts.fct_dbt__latest_full_model_executions
