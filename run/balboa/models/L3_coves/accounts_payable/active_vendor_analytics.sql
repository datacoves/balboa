create or replace semantic view BALBOA_STAGING.L3_ACCOUNTS_PAYABLE.active_vendor_analytics
...
tables (
    active_vendor_periods as L3_ACCOUNTS_PAYABLE.mart_active_vendors_by_period
)
