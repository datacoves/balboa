...
create or replace transient table BALBOA_STAGING.L3_ACCOUNTS_PAYABLE.mart_active_vendors_by_period
    copy grants
...
with purchase_orders as (
    ...
    from L2_PURCHASE_ORDERS.fct_purchase_orders
...
inner join L2_VENDORS.dim_vendors as vendors
