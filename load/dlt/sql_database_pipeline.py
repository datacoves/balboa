...
if __name__ == "__main__":
    pipeline = dlt.pipeline(pipeline_name="datacoves_tc2", destination="snowflake", dataset_name="tc2", progress="enlighten")
    table = sql_table(table="tc2_lineitem")
    table.apply_hints(write_disposition="merge", primary_key=["L_ORDERKEY", "L_LINENUMBER"])
